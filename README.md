...
4. Create **tile_definition.csv**:
    1. Start the **GnollHack Windows executable** as **Administrator** in **Wizard Mode** by using `-D -u wizard` command line parameters. *(You can create a shortcut for this. **Run as Administrator** is found under **Advanced** in the shortcut properties.)*
